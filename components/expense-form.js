                        ...
                        <form id="globalExpenseForm">
                            ...
                            <div class="form-group" style="position: relative;">
                                ...
                                <div style="display: flex; gap: 6px;">
                                    ...
                                    <button type="button" id="scanBarcodeExpenseBtn" class="btn btn-secondary" title="Scan patient barcode" style="padding: 8px; white-space: nowrap; flex-shrink: 0; width: auto; min-width: 0; flex-grow: 0;">📷</button>
                                </div>
